 ...
 */
public class MapAther extends AppCompatActivity implements
...
<<<<<<< HEAD
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MapAther.this, Charging.class);
...
>>>>>>> origin/master
        ...
        try {
            ...
            Log.e("MapAther", "onCreate: " + exception);
...
// gray_theme_button
        ...
        chosenTheme = getIntent().getIntExtra(SELECTED_THEME, R.style.AppTheme_Gray);
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                customThemeManager = new CustomThemeManager(chosenTheme, MapAther.this);
                ...
                mapboxMap.setStyle(new Style.Builder().fromUrl(customThemeManager.getMapStyle()), new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        MapAther.this.mapboxMap = mapboxMap;
                        ...
                        if (featureList != null) {
                            ...
                            mapboxMap.addOnMapClickListener(MapAther.this);

                            Toast.makeText(MapAther.this, "Click on a card", Toast.LENGTH_SHORT).show();
        ...
        directionsApiClient.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                ...
                if (response.body() == null) {
                    Log.e("MapAther", "No routes found, make sure you set the right user and access token.");
                } else if (response.body().routes().size() < 1) {
                    Log.e("MapAther", "No routes found");
                } else {
                    if (fromMarkerClick) {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                Toast.makeText(MapAther.this, R.string.failure_to_retrieve, Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        private void initializeTheme() {
            switch (selectedTheme) {
                ...
                case R.style.AppTheme_Gray:
                    ...
                    unselectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ather_icon);
                    selectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ather_icon);
